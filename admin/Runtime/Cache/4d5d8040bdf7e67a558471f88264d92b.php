			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="<?php echo U('Index/addjp');?>" method="post" enctype="multipart/form-data">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								
								<p>
									<label>机构名称</label>
										<input class="text-input small-input" type="text" id="small-input" name="company" value="<?php echo ($res["company"]); ?>"/>
								</p>
								
								<p>
									<label>感谢语</label>
										<input class="text-input small-input" type="text" id="small-input" name="thankinfo" value="<?php echo ($res["thankinfo"]); ?>"/>
								</p>
								
								<p>
									<label>奖品名称</label>
										<input class="text-input small-input" type="text" id="small-input" name="price" value="<?php echo ($res["price"]); ?>"/>
								</p>
								<p>
									<label>点击关闭提示无法获得信息</label>
										<input class="text-input small-input" type="text" id="small-input" name="info1" value="<?php echo ($res["info1"]); ?>"/>
										<br /><br />
										<input class="text-input small-input" type="text" id="small-input" name="info2" value="<?php echo ($res["info2"]); ?>"/>
										<br /><br />
										<input class="text-input small-input" type="text" id="small-input" name="info3" value="<?php echo ($res["info3"]); ?>"/>
										<br /><br />
										<input class="text-input small-input" type="text" id="small-input" name="info4" value="<?php echo ($res["info4"]); ?>"/>
										<br /><br />
								</p>

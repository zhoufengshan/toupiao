 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<a href="#" class="button">查看投票详情</a><br /><br />
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "还没有数据，请先添加" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><tbody>
								<tr>
									<td><?php echo ($result["id"]); ?></td>
									<td><?php echo ($result["openid"]); ?></td>
									<td><?php echo ($result["time"]); ?></td>
									<td><?php echo ($result["ip"]); ?></td>
									<td><?php echo ($result["address"]); ?></td>
									<td>
										<a href="<?php echo U('Index/delvote','id='.$result['id']);?>" title="删除"><input class="button" type="button" value="删除本IP投票数据"/></a>
									</td>
						...
						<a href="<?php echo U('Index/showsignup');?>"><input class="button" type="button" value="返回"/></a>
					</div> <!-- End #tab1 -->

			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="<?php echo U('Index/addimgcarous');?>" method="post" enctype="multipart/form-data">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								
								<p>
									<label>轮播图片上传</label>
										<input class="text-input small-input" type="file" id="small-input" name="photo" />
								</p>
								
								<p>
									<label>URL链接地址</label>
										<input class="text-input small-input" type="text" id="small-input" name="url" />
								</p>
								...
								<p>
									...
									<a href="<?php echo U('Index/showimgcarous');?>"><input class="button" type="button" value="查看" /></a>
								</p>
